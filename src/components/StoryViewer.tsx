...
const StoryViewer: React.FC<StoryViewerProps> = ({ movie, link, onClose, onNavigateToMovie, isFavorite, onToggleFavorite }) => {
         ...
         <div className="absolute bottom-0 left-0 right-0 p-6 z-20 pb-10 flex flex-col gap-6">
            ...
            {link ? (
              <button 
                  ...
                  className="w-full bg-gradient-to-r from-pink-600 to-rose-500 text-white font-extrabold py-4 rounded-xl flex items-center justify-center gap-2 hover:from-pink-500 hover:to-rose-400 transition-all shadow-[0_0_20px_rgba(225,29,72,0.3)] active:scale-95"
              >
            ...
            {link && (
              <button 
                  ...
                  className="w-full bg-white/10 text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 hover:bg-white/20 transition-all border border-white/10 active:scale-95"
              >
                  View Details
              </button>
            )}
